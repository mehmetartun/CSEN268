    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            title: const Text('Functions Demo'),
            onTap: () {
              context.pop();
              context.goNamed(MyNavigatorRoute.functionsDemo.name);
            },
          ),
          ListTile(
          ...
          ListTile(
            title: const Text('Generative AI Streaming'),
            onTap: () {
              context.pop();
              context.goNamed(MyNavigatorRoute.generativeAIStreaming.name);
            },
          ),
          ListTile(
            title: const Text('Generative AI Image Generation'),
            onTap: () {
              context.pop();
              context.goNamed(
                MyNavigatorRoute.generativeAIImageGeneration.name,
              );
            },
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () {
              context.pop();
              context.goNamed(MyNavigatorRoute.imageUpload.name);
            },
          ),
          ListTile(
